...
$('toastClose').onclick=hideToast;window.addEventListener('message',e=>{if(e.data.type==='recovery'){showRecoveryToast(e.data);e.stopImmediatePropagation()}else if(e.data.type==='error'){showErrorToast(e.data.message);e.stopImmediatePropagation()}},true);
